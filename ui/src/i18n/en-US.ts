export const enUS: Record<string, string> = {
  ...
  accessoryMembers: "Members",
  accessoryAddMember: "Add Member",
  accessorySetAsPrimary: "Set as primary",
  accessoryHideInDetail: "Hide in detail",
  accessoryShowInDetail: "Show in detail",
  accessoryRemoveFromAccessory: "Remove from accessory",
  accessoryPrimaryBadge: "Primary",
  accessoryHiddenBadge: "Hidden",
  accessoryPromotedBadge: "Promoted",
  addMemberModalTitle: "Add Member to Accessory",
  addMemberModalSearch: "Search entities...",
  addMemberModalAlreadyInOtherAccessory: "Currently in another accessory",
  addMemberModalNoResults: "No matching entities",
  addMemberModalLoading: "Loading...",
